...
public class SequenceTableMappingTests {
    ...
    public void 식별자_매핑_테스트() { ///////////////////////////
        //given
        com.ohgiraffers.section03.primarykey.subsection02.table.Member member = new com.ohgiraffers.section03.primarykey.subsection02.table.Member();
        ...
        String jpql = "SELECT A.memberNo FROM member_section03_subsection02 A"; // SQL문과 좀 다르다.
